const home_services = [
  {
    icon: "home/hero-slider-icon-1.svg",
    title: "24/7 support and optimization",
  },
  {
    icon: "home/hero-slider-icon-2.svg",
    title: "Proven ROI on all solutions",
  },
  {
    icon: "home/hero-slider-icon-3.svg",
    title: "Dedicated client success managers",
  },
  {
    icon: "home/hero-slider-icon-4.svg",
    title: "Real-time performance monitoring",
  },
  { icon: "home/hero-slider-icon-5.svg", title: "Security-first approach" },
  { icon: "home/hero-slider-icon-6.svg", title: "Multichannel support" },
];

const home_sponsers = [
  { icon: "home/sponser-1.svg" },
  { icon: "home/sponser-2.svg" },
  { icon: "home/sponser-3.svg" },
  { icon: "home/sponser-4.svg" },
  { icon: "home/sponser-5.svg" },
  { icon: "home/sponser-3.svg" },
  { icon: "home/sponser-6.svg" },
];

const Industrie = [
  { icon: "home/slider-image-1.webp", title: "Health care" },
  { icon: "home/slider-image-2.webp", title: "Financial services" },
  { icon: "home/slider-image-3.webp", title: "Technology" },
  { icon: "home/slider-image-4.webp", title: "Manufacturing" },
  { icon: "home/slider-image-2.webp", title: "Financial services" },
  { icon: "home/slider-image-5.webp", title: "Logistics & supply chain" },
];
...
export { home_services, home_sponsers, Industrie, home_blogs };
